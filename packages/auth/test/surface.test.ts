...
const request = (path: string) => new Request(`https://partner.truelend.in${path}`);

test("partner auth surface excludes raw signup and every admin endpoint", () => {
...
test("partner auth surface retains only normal account endpoints", () => {
