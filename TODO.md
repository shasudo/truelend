...
### Public website stakeholder revision — 2026-07-20

The public homepage now implements the approved screen-by-screen borrowing framework, product-solution grid, borrower-benefit copy, Ledger introduction, advisory CTA, assurance strip, and footer messaging. Contact and About now use their supplied responsive page designs with original optimized hero artwork; Contact also captures enquiry type and optional subject through the existing lead boundary without a database migration, and its lazy, keyless OpenStreetMap embed derives its marker and directions destination from centralized coordinates. Evidence: [`apps/website/app/page.tsx`](apps/website/app/page.tsx), [`apps/website/components/home-hero.tsx`](apps/website/components/home-hero.tsx), [`apps/website/app/contact/page.tsx`](apps/website/app/contact/page.tsx), [`apps/website/components/forms/contact-form.tsx`](apps/website/components/forms/contact-form.tsx), [`apps/website/app/about/page.tsx`](apps/website/app/about/page.tsx), and [`docs/product-imagery.md`](docs/product-imagery.md). Focused tests, typechecking, linting, formatting, and responsive browser checks passed locally. This visual implementation does not close P0-09: production contact values, coordinates, departmental inboxes, public claims, and legal/business approval still require named owners and external verification.
