import { isProductSlug, type ProductSlug } from "@truelend/reference";
 ...
 */
export function preselectedProduct(raw: string | string[] | undefined): ProductSlug | "" {
  const slug = Array.isArray(raw) ? raw[0] : raw;
  return slug && isProductSlug(slug) ? slug : "";
}
